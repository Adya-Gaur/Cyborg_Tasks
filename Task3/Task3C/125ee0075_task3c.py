...
class Task3C(Node):
    ...
    def control_loop(self):
        ...
        pdx = self.thief_pose.x - self.police_pose.x
        pdy = self.thief_pose.y - self.police_pose.y
        ...
        target_angle = math.atan2(pdy, pdx)
        heading_error = target_angle - self.police_pose.theta
